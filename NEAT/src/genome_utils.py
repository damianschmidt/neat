...
def get_nodes_innovations_and_indices(genome1, genome2):
    list_of_node_keys1 = [*genome1.dict_of_nodes].sort()
    list_of_node_keys2 = [*genome2.dict_of_nodes].sort()
...
def get_connections_innovations_and_indices(genome1, genome2):
    list_of_connection_keys1 = [*genome1.dict_of_connections].sort()
    list_of_connection_keys2 = [*genome2.dict_of_connections].sort()
...
def average_weight_diff(genome1, genome2):
    ...
    highest_innovation1, highest_innovation2, indices = get_connections_innovations_and_indices(genome1, genome2)
    for i in range(indices + 1):
        connection1, connection2 = get_connections(genome1, genome2)
