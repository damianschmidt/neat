...
class Game:
    ...
    def run_neat(self):
        try:
            with open('./results/winner_flappy_bird_fs_neat.pkl', 'rb') as input_file:
        ...
        stats = Statistics(task_name='flappy_bird_fs_neat')
        ...
        with open('results/winner_flappy_bird_fs_neat.pkl', 'wb') as output:
