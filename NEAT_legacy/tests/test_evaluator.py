...
class EvaluatorTestCase(unittest.TestCase):
    ...
    @patch('NEAT_legacy.src.genome_utils.compatibility_distance', MagicMock(return_value=5.0))
    ...
    @patch('NEAT_legacy.src.genome_utils.compatibility_distance', MagicMock(return_value=15.0))
