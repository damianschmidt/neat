...
class GenomeUtilsTestCase(unittest.TestCase):
    ...
    @patch('NEAT_legacy.src.genome_utils.count_excess_genes', MagicMock(return_value=1))
    @patch('NEAT_legacy.src.genome_utils.count_disjoint_genes', MagicMock(return_value=2))
    @patch('NEAT_legacy.src.genome_utils.average_weight_diff', MagicMock(return_value=3.0))
